...
import { register, updateStatus } from '../../../../actions/dnaLibMultiplex';
...
import DnaLibMultiplexsActions from './DnaLibMultiplexsActions'
import { getI7Primers } from '../../../../actions/i7Primer';
import { getI5Primers } from '../../../../actions/i5Primer';


export default function DnaLibMultiplexs() {

  const {
    state: { dnaLibMultiplexs, i7Primers, i5Primers },
    dispatch,
  } = useValue();
  ...
  const columns = useMemo(
    () =>  [
    {
      ...
      renderCell: (params) => (
        <DnaLibMultiplexsActions {...{ params, rows, setRows, rowModesModel, setRowModesModel }} />
      ),
    },
    ...
    { field: 'i5PrimerId', 
      ...
      valueOptions: i5Ids, 
      editable:true},
    { field: 'beadRatio', headerName: 'Bead Ratio', width: 150, editable: true },
    { field: 'status', 
      headerName: 'Status', 
      width: 100,
      type: 'singleSelect',
