...
const RunReportForm = () => {
  ...
  // const report_footer1 = "https://www.dropbox.com/s/6juy7b1xf6x6qj6/report_footer1.gif?dl=0"
  // const report_header1 = "https://www.dropbox.com/s/vxskiabs6by4h9x/report_header1.gif?dl=0"
  // const report_header1 = "https://raw.githubusercontent.com/dolanmiu/docx/master/demo/images/cat.jpg"
  // const report_header2 = "https://www.dropbox.com/s/kh3j47gubobh6p5/report_header2.gif?dl=0"


  // const header1 = await fetch(report_header1).then(r => r.blob())
  // console.log(header1)
  ...
  const handleClose = () => {
    dispatch({ type: 'CLOSE_SEQRUNREPORT' });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    Packer.toBlob(doc).then((blob) => {
        ...
        link.download = seqRunValue.label + "_Run_report.docx";
        link.href = url;
        link.click();
    });
