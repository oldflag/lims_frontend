...
import { register, updateStatus } from '../../../../actions/rnaLibrary';
...
import RnaLibrarysActions from './RnaLibrarysActions'
...
export default function RnaLibrarys() {
  ...
  const [rows, setRows] = useState(rnaLibrarys);
  ...
  const columns = useMemo(
    () =>  [
    {
      ...
      renderCell: (params) => (
        <RnaLibrarysActions {...{ params, rows, setRows, rowModesModel, setRowModesModel }} />
      ),
    },
    { field: 'name', headerName: 'Library Name', width: 150},
    { field: 'lysis_batch_name', headerName: 'Batch Name', width: 150, },
    { field: 'lysis_name', headerName: 'Lysis Name', width: 100},
